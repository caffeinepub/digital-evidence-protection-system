import { ab as commonjsGlobal, ac as getDefaultExportFromCjs, h as reactExports, ad as clsx, ae as React, af as invariant, x as useLang, o as jsxRuntimeExports, T as ThreeBackground3D, q as motion, F as Footer } from "./index-Ceaj9_Tu.js";
...
function AdminPanel() {
  ...
  const getStatusLabel = (status) => {
    if (lang === "hi") {
      const map2 = {
        "In Progress": t2("statusInProgress"),
        Pending: t2("statusPending"),
        Verified: t2("statusVerified"),
        "Under Review": t2("statusUnderReview"),
        Closed: t2("statusClosed")
      };
      return map2[status];
    }
    return status;
  ...
  const stats = [
    ...
    {
      label: t2("activeCasesCount"),
      value: 37,
      color: "#60a5fa",
      border: "rgba(59,130,246,0.3)"
    },
    {
      label: t2("pendingCasesCount"),
      value: 52,
      color: "#fb923c",
      border: "rgba(249,115,22,0.3)"
    },
    {
      label: t2("resolvedCases"),
      value: 59,
      color: "#4ade80",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(ThreeBackground3D, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "section",
          {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "p",
                      {
                        ...
                        children: t2("adminOverview")
                      }
                    )
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-4 mb-10", children: stats.map((s2, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                motion.div,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        ...
                        children: /* @__PURE__ */ jsxRuntimeExports.jsx(CountUp, { target: s2.value })
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      ...
                      "div",
                      {
                        ...
                        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: FAKE_RECORDS.map((rec, i) => {
                            const s2 = STATUS_STYLES[rec.status];
                            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                              motion.tr,
                              {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "admin.graphs.section", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "h2",
                  {
                    className: "text-lg font-semibold mb-4",
                    style: { color: "#f0f0f0" },
                    children: t2("adminGraphs")
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-6", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(ChartCard, { title: t2("evidenceByType"), children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 220, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    BarChart,
                    {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(ChartCard, { title: t2("caseStatusDist"), children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-3 mt-3 justify-center", children: CASE_STATUS_DIST.map((d2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          className: "w-2.5 h-2.5 rounded-full",
                          style: { background: d2.fill }
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs", style: { color: CHART_TEXT }, children: d2.name }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(ChartCard, { title: t2("uploadTrend"), children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 220, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    AreaChart,
                    {
                      data: UPLOAD_TREND,
                      margin: { top: 4, right: 4, left: -20, bottom: 0 },
