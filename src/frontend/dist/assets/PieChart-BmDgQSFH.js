import { a2 as commonjsGlobal, a3 as getDefaultExportFromCjs, h as reactExports, a1 as clsx, a0 as React, a4 as invariant } from "./index-Bl3e9hkw.js";
...
var _excluded$h = ["children"], _excluded2$5 = ["children"];
...
var hasClipDot = function hasClipDot2(dot) {
  return dot && _typeof$I(dot) === "object" && "clipDot" in dot;
};
...
var isSingleChildEqual = function isSingleChildEqual2(nextChild, prevChild) {
  ...
  if (!isNil$1(nextChild) && !isNil$1(prevChild)) {
    ...
    var _ref2 = prevChild.props || {}, prevChildren = _ref2.children, prevProps = _objectWithoutProperties$h(_ref2, _excluded2$5);
    if (nextChildren && prevChildren) {
...
function Surface(props) {
  ...
  return /* @__PURE__ */ React.createElement("svg", _extends$s({}, filterProps(others, true, "svg"), {
...
var Layer = /* @__PURE__ */ React.forwardRef(function(props, ref) {
  ...
  return /* @__PURE__ */ React.createElement("g", _extends$r({
    className: layerClass
...
var Symbols = function Symbols2(_ref) {
  ...
  if (cx === +cx && cy === +cy && size === +size) {
    return /* @__PURE__ */ React.createElement("path", _extends$q({}, filteredProps, {
...
function _objectSpread$z(e3) {
  for (var r = 1; r < arguments.length; r++) {
    var t2 = null != arguments[r] ? arguments[r] : {};
    r % 2 ? ownKeys$z(Object(t2), true).forEach(function(r2) {
      _defineProperty$F(e3, r2, t2[r2]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e3, Object.getOwnPropertyDescriptors(t2)) : ownKeys$z(Object(t2)).forEach(function(r2) {
      Object.defineProperty(e3, r2, Object.getOwnPropertyDescriptor(t2, r2));
    });
  }
  return e3;
  ...
  return _createClass$k(DefaultLegendContent2, [{
    ...
    value: function renderItems() {
      ...
      return payload.map(function(entry, i) {
        ...
        var className = clsx(_defineProperty$F(_defineProperty$F({
...
var Legend = /* @__PURE__ */ function(_PureComponent) {
  function Legend2() {
    ...
    _defineProperty$E(_this, "lastBoundingBox", {
      width: -1,
      height: -1
    });
    return _this;
...
var _excluded$c = ["x", "y", "lineHeight", "capHeight", "scaleToFit", "textAnchor", "verticalAnchor", "fill"], _excluded2$4 = ["dx", "dy", "angle", "className", "breakAll"];
function _extends$n() {
...
var Text = function Text2(_ref5) {
  ...
  var dx = props.dx, dy = props.dy, angle = props.angle, className = props.className, breakAll = props.breakAll, textProps = _objectWithoutProperties$c(props, _excluded2$4);
  ...
  return /* @__PURE__ */ React.createElement("text", _extends$n({}, filterProps(textProps, true), {
    x: x2,
    y: y2,
...
function _setPrototypeOf$d(o, p2) {
  _setPrototypeOf$d = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf2(o2, p22) {
    o2.__proto__ = p22;
    return o2;
  };
...
var formatAxisMap$1 = function formatAxisMap(props, axisMap, offset, axisType, chartName) {
  ...
  return ids.reduce(function(result, id) {
    ...
    var ticks2 = getTicksOfScale(scale, _objectSpread$q(_objectSpread$q({}, axis), {}, {
      realScaleType
    }));
    var finalAxis = _objectSpread$q(_objectSpread$q(_objectSpread$q({}, axis), ticks2), {}, {
      range: range3,
      radius: outerRadius,
      realScaleType,
      scale,
...
var renderRadialLabel = function renderRadialLabel2(labelProps, label, attrs) {
  ...
  return /* @__PURE__ */ React.createElement("text", _extends$l({}, attrs, {
...
function Label(_ref4) {
  ...
  return /* @__PURE__ */ React.createElement(Text, _extends$l({
...
var parseLabel = function parseLabel2(label, viewBox) {
  ...
  if (isObject$8(label)) {
    return /* @__PURE__ */ React.createElement(Label, _extends$l({
      viewBox
    }, label, {
      key: "label-implicit"
    }));
...
var _excluded$9 = ["valueAccessor"], _excluded2$3 = ["data", "dataKey", "clockWise", "id", "textBreakAll"];
...
function LabelList(_ref) {
  ...
  return /* @__PURE__ */ React.createElement(Layer, {
    ...
    return /* @__PURE__ */ React.createElement(Label, _extends$k({}, filterProps(entry, true), others, idProps, {
      parentViewBox: entry.parentViewBox,
      value,
      textBreakAll,
      viewBox: Label.parseViewBox(isNil$1(clockWise) ? entry : _objectSpread$o(_objectSpread$o({}, entry), {}, {
        clockWise
      })),
      key: "label-".concat(index),
      index
...
function parseLabelList(label, data) {
  ...
  if (isObject$8(label)) {
    return /* @__PURE__ */ React.createElement(LabelList, _extends$k({
      data
    }, label, {
      key: "labelList-implicit"
    }));
...
var Sector = function Sector2(sectorProps) {
  var props = _objectSpread$n(_objectSpread$n({}, defaultProps$2), sectorProps);
...
var Curve = function Curve2(props) {
  ...
  return /* @__PURE__ */ reactExports.createElement("path", _extends$i({}, filterProps(props, false), adaptEventHandlers(props), {
...
var mapObject = function mapObject2(fn, obj) {
  return Object.keys(obj).reduce(function(res, key) {
    return _objectSpread$l(_objectSpread$l({}, res), {}, _defineProperty$o({}, key, fn(key, obj[key])));
  }, {});
};
...
var calStepperVals = function calStepperVals2(easing, preVals, steps) {
  var nextStepVals = mapObject(function(key, val) {
    if (needContinue(val)) {
      ...
      return _objectSpread$k(_objectSpread$k({}, val), {}, {
        from: newX,
        velocity: newV
      });
    }
...
const configUpdate = function(from, to, easing, duration, render) {
  ...
  var timingStyle = interKeys.reduce(function(res, key) {
    return _objectSpread$k(_objectSpread$k({}, res), {}, _defineProperty$n({}, key, [from[key], to[key]]));
  }, {});
  var stepperStyle = interKeys.reduce(function(res, key) {
    return _objectSpread$k(_objectSpread$k({}, res), {}, _defineProperty$n({}, key, {
      from: from[key],
      velocity: 0,
      to: to[key]
    }));
  ...
  var stepperUpdate = function stepperUpdate2(now2) {
    ...
    render(_objectSpread$k(_objectSpread$k(_objectSpread$k({}, from), to), getCurrStyle()));
    preTime = now2;
  ...
  var timingUpdate = function timingUpdate2(now2) {
    ...
    render(_objectSpread$k(_objectSpread$k(_objectSpread$k({}, from), to), currStyle));
    if (t2 < 1) {
      cafId = requestAnimationFrame(update);
    } else {
      ...
      render(_objectSpread$k(_objectSpread$k(_objectSpread$k({}, from), to), finalStyle));
    }
  };
...
var Animate = /* @__PURE__ */ function(_PureComponent) {
  ...
  _createClass$e(Animate2, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      this.runAnimation(_objectSpread$j(_objectSpread$j({}, this.props), {}, {
        from,
        begin: 0
      }));
    }
    ...
    value: function runStepAnimation(props) {
      ...
      var addStyle = function addStyle2(sequence, nextItem, index) {
        ...
        var newStyle = _objectSpread$j(_objectSpread$j(_objectSpread$j({}, preItem.style), style), {}, {
          transition
        });
    ...
    value: function runAnimation(props) {
      ...
      manager.start([onAnimationStart2, begin, _objectSpread$j(_objectSpread$j({}, to), {}, {
        transition
    ...
    value: function render() {
      ...
      var cloneContainer = function cloneContainer2(container) {
        ...
        var res = /* @__PURE__ */ reactExports.cloneElement(container, _objectSpread$j(_objectSpread$j({}, others), {}, {
          style: _objectSpread$j(_objectSpread$j({}, style), stateStyle),
          className
        }));
        return res;
      };
...
var Rectangle = function Rectangle2(rectangleProps) {
  ...
  return /* @__PURE__ */ React.createElement(Animate, {
    ...
    }, /* @__PURE__ */ React.createElement("path", _extends$h({}, filterProps(props, true), {
      className: layerClass,
...
var _excluded$7 = ["points", "className", "baseLinePoints", "connectNulls"];
function _extends$g() {
...
var Polygon = function Polygon2(props) {
  ...
  if (baseLinePoints && baseLinePoints.length) {
    ...
    return /* @__PURE__ */ React.createElement("g", {
      className: layerClass
    }, /* @__PURE__ */ React.createElement("path", _extends$g({}, filterProps(others, true), {
      fill: rangePath.slice(-1) === "Z" ? others.fill : "none",
      stroke: "none",
      d: rangePath
    })), hasStroke ? /* @__PURE__ */ React.createElement("path", _extends$g({}, filterProps(others, true), {
      fill: "none",
      d: getSinglePolygonPath(points, connectNulls)
    })) : null, hasStroke ? /* @__PURE__ */ React.createElement("path", _extends$g({}, filterProps(others, true), {
      fill: "none",
      d: getSinglePolygonPath(baseLinePoints, connectNulls)
    })) : null);
  }
  var singlePath = getSinglePolygonPath(points, connectNulls);
  return /* @__PURE__ */ React.createElement("path", _extends$g({}, filterProps(others, true), {
...
var Dot = function Dot2(props) {
  ...
  if (cx === +cx && cy === +cy && r === +r) {
    return /* @__PURE__ */ reactExports.createElement("circle", _extends$f({}, filterProps(props, false), adaptEventHandlers(props), {
      className: layerClass,
      cx,
      cy,
      r
...
var _excluded$5 = ["cx", "cy", "angle", "ticks", "axisLine"], _excluded2$2 = ["ticks", "tick", "angle", "tickFormatter", "stroke"];
function _typeof$j(o) {
  "@babel/helpers - typeof";
  return _typeof$j = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(o2) {
    return typeof o2;
...
var PolarRadiusAxis = /* @__PURE__ */ function(_PureComponent) {
  ...
  return _createClass$d(PolarRadiusAxis2, [{
    ...
    value: function renderAxisLine() {
      var _this$props3 = this.props, cx = _this$props3.cx, cy = _this$props3.cy, angle = _this$props3.angle, ticks2 = _this$props3.ticks, axisLine = _this$props3.axisLine, others = _objectWithoutProperties$5(_this$props3, _excluded$5);
      var extent = ticks2.reduce(function(result, entry) {
        return [Math.min(result[0], entry.coordinate), Math.max(result[1], entry.coordinate)];
      }, [Infinity, -Infinity]);
      var point0 = polarToCartesian(cx, cy, extent[0], angle);
      var point1 = polarToCartesian(cx, cy, extent[1], angle);
      var props = _objectSpread$g(_objectSpread$g(_objectSpread$g({}, filterProps(others, false)), {}, {
        fill: "none"
      ...
      return /* @__PURE__ */ React.createElement("line", _extends$d({
    ...
    value: function renderTicks() {
      var _this = this;
      var _this$props4 = this.props, ticks2 = _this$props4.ticks, tick = _this$props4.tick, angle = _this$props4.angle, tickFormatter = _this$props4.tickFormatter, stroke = _this$props4.stroke, others = _objectWithoutProperties$5(_this$props4, _excluded2$2);
...
var PolarAngleAxis = /* @__PURE__ */ function(_PureComponent) {
  ...
  return _createClass$c(PolarAngleAxis2, [{
    ...
    value: function renderAxisLine() {
      ...
      var props = _objectSpread$f(_objectSpread$f({}, filterProps(this.props, false)), {}, {
        fill: "none"
      }, filterProps(axisLine, false));
      if (axisLineType === "circle") {
        return /* @__PURE__ */ React.createElement(Dot, _extends$c({
      ...
      return /* @__PURE__ */ React.createElement(Polygon, _extends$c({
        className: "recharts-polar-angle-axis-line"
      }, props, {
        points
      }));
    ...
    value: function renderTicks() {
      ...
      var items = ticks2.map(function(entry, i) {
        ...
        return /* @__PURE__ */ React.createElement(Layer, _extends$c({
          ...
          key: "tick-".concat(entry.coordinate)
        }, adaptEventsOfChild(_this.props, entry, i)), tickLine && /* @__PURE__ */ React.createElement("line", _extends$c({
...
var Pie = /* @__PURE__ */ function(_PureComponent) {
  function Pie2(props) {
    ...
    _defineProperty$f(_this, "pieRef", null);
    _defineProperty$f(_this, "sectorRefs", []);
    _defineProperty$f(_this, "id", uniqueId("recharts-pie-"));
  ...
  return _createClass$b(Pie2, [{
    ...
    value: function renderSectorsStatically(sectors) {
      ...
      return sectors.map(function(entry, i) {
        ...
        }), /* @__PURE__ */ React.createElement(Shape, _extends$a({
    ...
    value: function renderLabelLineItem(option, props, key) {
      ...
      return /* @__PURE__ */ React.createElement(Curve, _extends$a({}, props, {
        key,
        type: "linear",
        className
      }));
    ...
    value: function renderLabelItem(option, props, value) {
      ...
      return /* @__PURE__ */ React.createElement(Text, _extends$a({}, props, {
...
_defineProperty$f(Pie, "getRealPieData", function(itemProps) {
...
_defineProperty$f(Pie, "parseCoordinateOfPie", function(itemProps, offset) {
...
_defineProperty$f(Pie, "getComposedData", function(_ref4) {
  ...
  var itemProps = item.type.defaultProps !== void 0 ? _objectSpread$c(_objectSpread$c({}, item.type.defaultProps), item.props) : item.props;
...
var Brush = /* @__PURE__ */ function(_PureComponent) {
  function Brush2(props) {
    ...
    _defineProperty$d(_this, "handleDrag", function(e3) {
      if (_this.leaveTimer) {
    ...
    _defineProperty$d(_this, "handleTouchMove", function(e3) {
    ...
    _defineProperty$d(_this, "handleSlideDragStart", function(e3) {
  ...
  return _createClass$a(Brush2, [{
    ...
    value: function handleTravellerMove(e3) {
      ...
      this.setState(_defineProperty$d(_defineProperty$d({}, movingTravellerId, prevValue + delta), "brushMoveStartX", e3.pageX), function() {
        if (onChange) {
          if (isFullGap()) {
            onChange(newIndex);
          }
...
export {
  ...
  useChartHeight as a,
  useOffset as b,
  useArbitraryXAxis as c,
  useYAxisWithFiniteDomainOrRandom as d,
  isFunction$3 as e,
  getTicks as f,
  getCoordinatesOfGrid as g,
  getTicksOfAxis as h,
  isNumber as i,
  filterProps as j,
  Curve as k,
  interpolateNumber$2 as l,
  max$1 as m,
  isNil$1 as n,
  isNan as o,
  isEqual$1 as p,
  ...
  LabelList as r,
  uniqueId as s,
  getValueByDataKey as t,
  useChartWidth as u,
  getCateCoordinateOfLine as v,
  warn as w,
  generateCategoricalChart as x,
  formatAxisMap2 as y,
  Bar as z
};
