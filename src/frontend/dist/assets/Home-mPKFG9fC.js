...
function CharSplitHeading({
  ...
  const chars = text.split("").map((char, i) => ({ char, key: `char-pos-${i}` }));
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: "▶ SCROLLYTELLING — DIGITAL EVIDENCE LIFECYCLE"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollProgressBeam, { scrollYProgress }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollPanels, { scrollYProgress })
          ]
        }
      )
    }
...
function Home() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { background: "#0a0a0f" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "section",
      {
        ref: heroRef,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-5xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 px-4 cyber-grid", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          initial: { opacity: 0, y: 20 },
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "h2",
              {
                ...
                style: { color: "#f0f0f0" },
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(CharSplitHeading, { text: "Core " }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#DC2626" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(CharSplitHeading, { text: "Capabilities" }) })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "rgba(240,240,240,0.5)" }, children: "Built to meet the rigorous demands of digital forensics and legal proceedings." })
          ]
        }
      ),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          initial: { opacity: 0, y: 20 },
